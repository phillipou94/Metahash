...
class AuthenticationsControllerTest < ActionController::TestCase
  ...
  test "should update authentication" do
    patch :update, id: @authentication, authentication: { create: @authentication.create, destroy: @authentication.destroy, index: @authentication.index, provider: @authentication.provider, uid: @authentication.uid, user_id: @authentication.user_id }
    assert_redirected_to authentication_path(assigns(:authentication))
  end
